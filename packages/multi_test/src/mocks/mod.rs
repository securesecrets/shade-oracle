...
mod shadeswap {
    ...
    use shade_oracles::protocols::shadeswap::{PairInfo, ShadeSwapQueryMsgResponse, QueryMsg};
    ...
    impl MockShadeswapPairHelper {
        ...
        pub fn query_pair_info(&self, app: &App) -> PairInfo {
            let msg: ShadeSwapQueryMsgResponse = QueryMsg::GetPairInfo {}.test_query(&self.0, app).unwrap();
            match msg {
                ShadeSwapQueryMsgResponse::GetPairInfo { liquidity_token, factory, pair, amount_0, amount_1, total_liquidity, contract_version, fee_info, stable_info } => PairInfo { liquidity_token, factory, pair, amount_0, amount_1, total_liquidity, contract_version, fee_info, stable_info },
