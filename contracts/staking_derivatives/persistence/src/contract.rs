...
const ACTION_PREFIX: &str = "persistence-staking-derivatives-oracle_";
...
pub fn execute(deps: DepsMut, env: Env, info: MessageInfo, msg: ExecuteMsg) -> StdResult<Response> {
    BotStakingDerivativesOracle::execute(deps, env, info, msg, BotPermission::UpdatePersistenceRates, ACTION_PREFIX)
}
