...
pub mod testnet {
    ...
    pub mod sienna {
        ...
        pub const STKD_SCRT_SCRT_POOL_HASH: &str =
            "33EAC42C44EE69ACFE1F56CE7B14FE009A7B611E86F275D7AF2D32DD0D33D5A9";
        pub const STKD_SCRT_SCRT_TOKEN_NAME: &str = "SiennaSwap Liquidity Provider (LP) token for secret15kuyl5e74fp3xqfzctn3gff0lxw44k4utqpzyw-secret18vd8fpwxzck93qlwghaj6arh4p7c5n8978vsyg";

        pub const STKD_SCRT_SHD_POOL: &str = "secret1y25r7qjnllktj8cr60pf6avuer3jxqqulpjapt";
        pub const STKD_SCRT_SHD_POOL_HASH: &str =
            "33eac42c44ee69acfe1f56ce7b14fe009a7b611e86f275d7af2d32dd0d33d5a9";
        pub const STKD_SCRT_SHD_TOKEN_NAME: &str = "SiennaSwap Liquidity Provider (LP) token for secret19ymc8uq799zf36wjsgu4t0pk8euddxtx5fggn8-secret15kuyl5e74fp3xqfzctn3gff0lxw44k4utqpzyw";

        pub const SHD_SSCRT_POOL: &str = "secret1pak8feexy97myp22pjkxmsp5p8dmlkp4mkfxsl";
        pub const SHD_SSCRT_POOL_HASH: &str =
            "33eac42c44ee69acfe1f56ce7b14fe009a7b611e86f275d7af2d32dd0d33d5a9";
        pub const SHD_SSCRT_TOKEN_NAME: &str = "SiennaSwap Liquidity Provider (LP) token for secret19ymc8uq799zf36wjsgu4t0pk8euddxtx5fggn8-secret18vd8fpwxzck93qlwghaj6arh4p7c5n8978vsyg";
    }
