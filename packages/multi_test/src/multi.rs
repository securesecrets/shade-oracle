#[cfg(feature = "stability-pool")]
pub mod stability_pool {
    use stability_pool;
    pub struct StabilityPool { info: ContractInfo }

    multi_derive::implement_multi!(StabilityPool, stability_pool);
}

#[cfg(feature = "rewards")]
pub mod rewards {
    use rewards;
    pub struct RewardsPool { info: ContractInfo }

    multi_derive::implement_multi!(RewardsPool, rewards);
}
