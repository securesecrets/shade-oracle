...
const ACTION_PREFIX: &str = "stride-staking-derivatives-oracle_";
...
pub fn execute(deps: DepsMut, env: Env, info: MessageInfo, msg: ExecuteMsg) -> StdResult<Response> {
    BotStakingDerivativesOracle::execute(deps, env, info, msg, BotPermission::UpdateStrideRates, ACTION_PREFIX)
}
